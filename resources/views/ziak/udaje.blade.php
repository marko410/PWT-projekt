...
<a href="{{route('student_main_screen')}}"><button style="width:220px" class="btn btn-secondary"> Späť</button></a><br><br>     
       <h2>Moje osobné údaje</h2><br> 
...
$(".save_input").click(function(){
    ...
    $.ajax({
      url: "{{route('student_osobne_udaje_post')}}",
      type:"POST",
      data:{
