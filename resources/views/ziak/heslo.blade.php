...
<a href="{{route('student_main_screen')}}"><button class="btn btn-secondary">Späť</button></a><br><br>     
...
<form method="POST" id='form_pilot' class="form_special" action="{{route('student_zmena_hesla_post')}}">
