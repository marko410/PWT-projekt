...
@if(session('pilot_deleted'))
        ...
        <div class="alert alert-dark" role="alert">
           Žiak {{session('pilot_deleted')}} zmazaný!
        ...
        <div class="alert alert-dark" role="alert">
           Žiak {{session('pilot_added')}} pridaný!
       ...
       @foreach($all_ziaci as $pilot)
        <p><a class="hover_pilot" href="{{route('boss_one_ziak_show',['id'=>$pilot->id])}}">{{$pilot->f_name}} {{$pilot->l_name}}</p>
