...
<a href="{{route('boss_all_ziaci')}}"><button style="width:220px" class="btn btn-secondary"><i class="fa fa-users" aria-hidden="true"></i> Späť na všetkých žiakov</button></a><br><br>     
